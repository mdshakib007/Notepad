...
import push_report as prt

class ReportGUI:
    def __init__(self, master):
        self.master = master
        master.title('Submit Report')
        master.maxsize(430, 430)
        master.minsize(430, 430)

        tk.Label(master, text='Report an issue_', font='monospace 25 bold').grid(
        ...
        tk.Label(master, text='Issue', font='monospace 12 bold').grid(row=3, column=0, pady=10)
    ...
    def submit_report(self):
        ...
        if name_data == '':
            ...
            tmsg.showinfo('Submitted Successfully!', 'Your report submitted successfully.')
